...
<script type="text/javascript" src="${pageContext.request.contextPath}res/js/angular.min.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}res/js/ProgressObject.js"></script>
...
<body onload='resizing();onLoad()' ng-app="myApp" ng-controller='myCtrl'>
	...
	<div class="body" id="body_div">
		...
		<div class="container center" id="index_div_row">
			...
			<table style="width: 80%;" class="table center" ng-show="( PendingFriendsEmpty && (currentUser == data.Username) )">
				...
				<tr>
					<td ng-show="( !PendingFriendsEmpty && (currentUser == data.Username) )">
						<br>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}res/js/resizebody.js"></script>
